...
ALTER TABLE casinos 
  ADD COLUMN IF NOT EXISTS entry_type TEXT DEFAULT 'casino' CHECK (entry_type IN ('casino', 'sister-site', 'blog', 'review-site')),
...
COMMENT ON COLUMN casinos.external_url IS 'External URL for blogs and review sites';
